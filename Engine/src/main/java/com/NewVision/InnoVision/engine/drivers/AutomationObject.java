 ...
 */
package com.NewVision.InnoVision.engine.drivers;

import com.NewVision.InnoVision.datalib.or.ObjectRepository;
import com.NewVision.InnoVision.datalib.or.common.ORAttribute;
import com.NewVision.InnoVision.datalib.or.common.ObjectGroup;
import com.NewVision.InnoVision.datalib.or.image.ImageORObject;
import com.NewVision.InnoVision.datalib.or.mobile.MobileORObject;
import com.NewVision.InnoVision.datalib.or.mobile.MobileORPage;
import com.NewVision.InnoVision.datalib.or.web.WebORObject;
import com.NewVision.InnoVision.datalib.or.web.WebORPage;
import com.NewVision.InnoVision.engine.constants.SystemDefaults;
import com.NewVision.InnoVision.engine.core.Control;
import com.NewVision.InnoVision.engine.drivers.findObjectBy.support.ByObjectProp;
		...
		try {
			if (frameData != null && !frameData.trim().isEmpty()) {
				...
				if (frameData.trim().matches("[0-9]+")) {
					...
					WebDriverWait wait = new WebDriverWait(driver, SystemDefaults.waitTime.get());
