 ...
 */
package com.NewVision.InnoVision.engine.support.methodInf;

import com.NewVision.InnoVision.datalib.component.TestStep;
import com.NewVision.InnoVision.engine.support.AnnontationUtil;
import com.NewVision.InnoVision.engine.support.reflect.Discovery;
import com.NewVision.InnoVision.engine.support.reflect.MethodExecutor;
...
public class MethodInfoManager {
    ...
    public static void load() {
        MethodExecutor.init();
        methodInfoMap.clear();
        AnnontationUtil.detect(ANNOTATION_DETECTOR, "com.NewVision.InnoVision.engine.commands");
    }
