 ...
 */
package com.NewVision.InnoVision.engine.reporting.impl.extent;

import java.io.File;
import java.io.IOException;
import org.apache.http.client.ClientProtocolException;
import org.json.simple.parser.ParseException;
import com.NewVision.InnoVision.engine.constants.FilePath;
...
import com.NewVision.InnoVision.engine.core.RunContext;
import com.NewVision.InnoVision.engine.core.RunManager;
import com.NewVision.InnoVision.engine.reporting.SummaryReport;
import com.NewVision.InnoVision.engine.reporting.TestCaseReport;
import com.NewVision.InnoVision.engine.reporting.impl.handlers.PrimaryHandler;
import com.NewVision.InnoVision.engine.reporting.impl.handlers.SummaryHandler;
import com.NewVision.InnoVision.engine.reporting.extentreport.ExtentReport;
import com.NewVision.InnoVision.engine.support.DesktopApi;
...
//        side-nav-menu
        ...
        extentReport.sparkReporter.config().setJs("document.querySelector('.nav-right').innerHTML += '<li ><img src=\"" + path + "/Engine/src/main/resources/reporting/logo.png\" class=\"r-img\"></li>';");
        extentReport.sparkReporter.config().setCss(".r-img {width: 56%; align:center;}");
